            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="../Traitement/Inscription.php" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="prenom" id="surname" placeholder="Votre prénom"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="confirm" id="pass" placeholder="Confirmer le mot de passe"/>
                            </div>
