...
<!-- Affichage du tableau conteant des informations -->
        ...
        <div class="table100 ver3 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Film</th>
									<th class="cell100 column2">Salle</th>
									<th class="cell100 column3">Prix</th>
									<th class="cell100 column4">Personnes</th>
					...
					<div class="table100-body js-pscroll">
						<table>
							<tbody>
								<?php
								$req = $bdd->prepare('SELECT film, num_salle, prix, nb_pers, date_prevue FROM reservation INNER JOIN salle ON num_salle=num WHERE nom=?');
                $req->execute(array($_SESSION['nom']));
								...
								foreach ($donnees as $value) {
									echo '<tr class="row100 body">
												...
												<td class="cell100 column2">'.$value["num_salle"].'</td>
												<td class="cell100 column3">'.$value["prix"].'</td>
												<td class="cell100 column4">'.$value["nb_pers"].'</td>
												<td class="cell100 column5">'.$value["date_prevue"].'</td>
												</tr>';
								}
								?>
